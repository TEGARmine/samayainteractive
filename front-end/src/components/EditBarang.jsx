...
import { getBarangById, updateBarang, getSuppliers } from "../services/api";
...
function EditBarang() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await updateBarang(id, { ...barang, supplier_id: selectedSupplier });
      navigate("/barang");
    } catch (error) {
      setError(error.response?.data?.message || "Failed to update barang");
    }
  };
  ...
  return (
    <div>
      <h1 className="text-center mb-10 font-semibold text-3xl">Edit Barang</h1>
